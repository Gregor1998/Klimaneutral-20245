    ...
    for year in range(2015,2024):
        ...
        for day in range(365):
            ...
            if directoryInstalled.get(year+1) is not None:
                ...
                performance_factors["Photovoltaik"][start_index:end_index] = directoryGeneration[year]["Photovoltaik"][start_index:end_index] / PV_factor
                performance_factors["Wind Onshore"][start_index:end_index] = directoryGeneration[year]["Wind Onshore"][start_index:end_index] / OnShore_factor
                performance_factors["Wind Offshore"][start_index:end_index] = directoryGeneration[year]["Wind Offshore"][start_index:end_index] / OffShore_factor
        ...
        directory_performance_factors[year].to_csv(f"Performance_Factors_{year}.csv", index = True)
