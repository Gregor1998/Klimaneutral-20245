...
def differenceBetweenDataframes(df1, df2):
    if df1['Datum'].equals(df2['Datum']):
        ...
        differences_df1 = df1['Datum'][~comparison]
        differences_df2 = df2['Datum'][~comparison]
        
        print("Unterschiede in df1['Datum']:", differences_df1)
        print("Unterschiede in df2['Datum']:", differences_df2)
